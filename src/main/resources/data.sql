...
INSERT INTO works (contractor, title, category, description, sharing_date, due_date, price, currency_id, guarantee_value, guarantee_length_id, starting_date, bid, min_bidder_user_rate, bid_expire_date) VALUES
    ...
    (2, 'I will design a professional menu for you', 'art', '3 to 6 sided menu design, aprox A4, high resolution. Ready to print.', '2018-07-01 00:00:00', '2018-07-30 00:00:00', 800, 3, 1, 3, '2018-07-03 00:00:00', false, 7, null),

    (4, 'Weapons for hire!', 'art', 'Hire a PS-3000 tool, because the problem solved when it''s source is 6 feet under. Problem Solver 3000 is your perfect choice.', '2018-07-01 00:00:00', '2018-08-23 18:00:00', 1500, 3, 1, 1, '2018-07-03 00:00:00', false, 3, null)
;
